...
class EEGDataset():
    ...
    def __init__(self, data_path, exclude_subject=None, subjects=None, train=True, time_window=[0, 1.0], classes = None, pictures = None):
        ...
        if self.classes is None and self.pictures is None:
            ...
            features_filename = os.path.join(f'data/weights/EEG_Image_decode/train_image_latent_512.pt') if self.train else os.path.join(f'data/weights/EEG_Image_decode/test_image_latent_512.pt')
